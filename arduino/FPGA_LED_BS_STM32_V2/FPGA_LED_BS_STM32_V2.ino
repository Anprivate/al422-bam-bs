...
// bytes per pixel - 3 for TRUECOLOR, 2 for HIGHCOLOR
#define bpp 3

// bits per color (2..15) after gamma correction
#define bpc 8
...
LED_PANEL led_panel = LED_PANEL(width, height, scan_lines, RGB_inputs, WE_out_pin, bpp, bpc);
